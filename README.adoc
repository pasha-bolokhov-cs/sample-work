...
Observables are most effectively demontrated by seeing how changes to a database instantly propagate to the view of the app — no hooks or callbacks are involved.
