...
Observables are most effectively demontrated by noticing how changes to a database instantly propagate to the view of the app — no hooks or callbacks are involved.
